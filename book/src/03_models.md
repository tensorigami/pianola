...
\draw[very thick] (-7, 0.6) -- (7, 0.6) ;
\draw[very thick] (-7, -1.4) -- (-4, -1.4) to[out=0, in=180, looseness=1.5] (-2.5,-0.65);
\draw[very thick] ( 7, -1.4) -- (0.5, -1.4) to[out=180, in=0, looseness=1.5] (  -1,-0.65);

\draw[very thick, rounded corners] (-5,-1) rectangle (-3.5,0);
\draw[very thick, rounded corners] (-2.5,-1) rectangle (-1,0);
\node at (-4.25,-0.5) {$\mathtt{rmsnorm}$};
\node at (-1.75,-0.5) {$\mathtt{attention}$};

\draw[very thick] (-5.5,0.6) to[out=-90, in=180, looseness=1] (-5,-0.5) ;
\draw[very thick] (-3.5,-0.35) -- (-2.5,-0.35) ;
\draw[very thick] (-1,-0.35) to[out=0, in=-90, looseness=1] (-0.5,0.6) ;

\draw[very thick, rounded corners] (5,-1) rectangle (3.5,0);
\draw[very thick, rounded corners] (2.5,-1) rectangle (1,0);
\node at (4.25,-0.5) {$\mathtt{ffn}$};
\node at (1.75,-0.5) {$\mathtt{rmsnorm}$};

\draw[very thick] (5.5,0.6) to[out=-90, in=0, looseness=1] (5,-0.5) ;
\draw[very thick] (3.5,-0.5) -- (2.5,-0.5) ;
\draw[very thick] (1,-0.5) to[out=180, in=-90, looseness=1] (0.5,0.6) ;
